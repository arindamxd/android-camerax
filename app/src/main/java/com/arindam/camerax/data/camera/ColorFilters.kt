...
object ColorFilters {
    ...
    fun glMatrix(type: ColorFilterType): FloatArray = when (type) {
        ...
        ColorFilterType.BRIGHT -> floatArrayOf(
            1f, 0f, 0f, 0f,
            0f, 1f, 0f, 0f,
            0f, 0f, 1f, 0f,
            0.35f, 0.35f, 0.35f, 1f
        )
        ColorFilterType.CONTRAST -> floatArrayOf(
            1.6f, 0f, 0f, 0f,
            0f, 1.6f, 0f, 0f,
            0f, 0f, 1.6f, 0f,
            -0.3f, -0.3f, -0.3f, 1f
    ...
    fun androidMatrix(type: ColorFilterType): ColorMatrix = when (type) {
        ...
        ColorFilterType.BRIGHT -> ColorMatrix(
            floatArrayOf(
                1f, 0f, 0f, 0f, 89f,
                0f, 1f, 0f, 0f, 89f,
                0f, 0f, 1f, 0f, 89f,
        ...
        ColorFilterType.CONTRAST -> ColorMatrix(
            floatArrayOf(
                1.6f, 0f, 0f, 0f, -76.5f,
                0f, 1.6f, 0f, 0f, -76.5f,
                0f, 0f, 1.6f, 0f, -76.5f,
